...
def realtime():
    realtime = []
    res = requests.get("https://www.naver.com/srchrank?frm=main&ag=all&gr=3&ma=-2&si=-2&en=-2&sp=-2")
    result = res.json()
...
def movies():
    ...
    #http://localhost:8001/daum/movies?week=10
